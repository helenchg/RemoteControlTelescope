...
public void checkbox1_clicked1(GCheckbox source, GEvent event) { //_CODE_:checkbox1:791909:
...
public void createGUI(){
  ...
  checkbox1 = new GCheckbox(this, 90, 40, 120, 20);
  ...
  motorPanel.addControl(checkbox1);
  motorPanel.addControl(label8);
  motorPanel.addControl(label9);
