...
void setup()
{
  ...
  Serial.begin(9600);
  pinMode(outputPin, OUTPUT);  // Set output pin for sending signal to motor speed
  //initialize the variables we're linked to
  Input = analogRead(inputPin);
  Setpoint = 100;
  pinMode(inputPin, INPUT); // get motor position from encoder
...
{
  analogWrite(outputPin, motorSpeed);
